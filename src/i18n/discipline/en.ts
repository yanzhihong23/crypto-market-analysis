...
export const disciplineEn: DisciplineContent = {
  ...
  sections: [
...

    {
      ...
      title: 'Perpetual data: the half a chart cannot show',
      blocks: [
        {
          kind: 'paragraph',
          text: 'Every row in the table above is a rearrangement of price, and would compute the same in any market. Funding, open interest, basis, the long/short ratio and liquidations are not: they describe positioning — who is holding what, at what carrying cost, and how fragile it is. A candle structurally cannot contain that, and it is the closest thing to an edge available to a retail trader here, precisely because it is not a lagging transform of price. Which is why it gets a section rather than a seventh row.',
        },
        {
          kind: 'table',
          headers: ['Reading', 'What it says', 'How to use it'],
          rows: [
            [
              'Funding',
              'Which side is paying to hold, and how much',
              'Price it into R as a cost first. Sustained extremes mean one side is crowded — raise your guard for the reverse, but it cannot time anything',
            ],
            [
              'Open interest',
              'How many contracts are open: money arriving or money leaving',
              'Always read against price, per the quadrants below. On its own it means nothing',
            ],
            [
              'Basis',
              'How far the contract sits from the spot index',
              'An extreme premium is the contract chasing spot. Convergence is certain; its timing is not, so it is not an entry',
            ],
            [
              'Long/short ratio and elite-retail divergence',
              'Crowding at the account level, and which side each group is on',
              'Read the deviation from its own history, never the absolute level. A widening split tends to show up near turns',
            ],
            [
              'Liquidations',
              'Who is being removed involuntarily',
              'A risk switch, and the trigger for the squeeze recipe. Never trend confirmation',
            ],
            [
              'Taker direction',
              'Who is crossing the spread to get filled',
              'One of the firmer pieces of directional evidence. Extreme readings cluster at the end of a move',
            ],
            [
              'Spread',
              'What getting in and out costs right now',
              'A cost, not a signal. When it widens is not when you open something new',
            ],
          ],
        },
        {
          kind: 'subTable',
          title: 'Price against open interest: the four quadrants',
          headers: ['Combination', 'What is happening', 'What it means'],
          rows: [
            [
              'Price up, OI up',
              'New long money arriving',
              'The most trend-like combination there is. Hold with it, stop by structure',
            ],
            [
              'Price up, OI down',
              'Shorts closing',
              'Short covering, and the fuel is finite. Not a trend start — prefer trimming into strength',
            ],
            [
              'Price down, OI up',
              'New short money arriving',
              'The fall has participation. Treat bounces as retracements rather than bottoms',
            ],
            [
              'Price down, OI down',
              'Longs closing or being cleared out',
              'Deleveraging, and it often lands near a durable low — but wait for the liquidations to stop before calling it an entry',
            ],
          ],
        },
        {
          kind: 'table',
          headers: ['Taken together', 'What it usually is', 'What to do'],
          rows: [
            [
              'Funding extreme + OI high + price stalling',
              'Crowding has run out of room and a squeeze is building',
              'Stop adding, shorten the hold, and have the squeeze-reversal recipe ready',
            ],
            [
              'Funding mild + OI rising with price',
              'A healthy trend with money arriving normally',
              'Trade with it at a normal holding period; no reason to leave early',
            ],
            [
              'Liquidations spiking + OI collapsing',
              'The clearing is happening right now',
              'Do not chase direction. Wait for it to stop and for the swept level to be reclaimed',
            ],
            [
              'Basis and funding disagreeing',
              'Spot and the contract are arguing; the evidence is not aligned',
              'Lower your confidence in the trade — half size, or skip it',
            ],
          ],
        },
        {
          kind: 'note',
          title: 'What this layer cannot do',
          items: [
