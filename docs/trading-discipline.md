...
| Base risk per trade (2% ceiling) | 1%                 |
...
Which band you pick is not a preference, it is buying the size of each win with the depth of the drawdown. At a 45% hit rate the longest losing streak in 250 trades runs about nine (ln(250) ÷ ln(1 ÷ 0.55)): that streak alone costs 8.6% at 1%, 16.6% at 2% and 24.0% at 3%. Count the scattered losses around it and an ordinary year looks like the right-hand column.

| Risk per trade | When this band applies                                                                                                                           | Peak-to-trough in an ordinary year |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- |
| 0.5%           | Calibrating: fewer than 50 trades recorded in R, or expectancy not yet positive. On an unproven system, more risk only reaches the answer faster | 7%–9%                              |
| 1%             | The default. A verified system traded at any real frequency                                                                                      | 13%–17%                            |
| 2%             | The ceiling. Verified and low frequency — a few trades a week, not a few a day — and you accept the right-hand column now                        | 25%–33%                            |
| 3%             | Not a band but an exception. Write down why this one is worth it; if you cannot, there is no reason                                              | 36%–48%                            |
